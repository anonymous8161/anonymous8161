...
def filter_steep_points(contour):
    ...
    for i in range(1, len(contour)):
        ...
        if angle <= 180: # 45-70 is also acceptable
...
def smooth_contour(contour, gray_image, smoothness=10, is_upper=True):
    ...
    top_limit = height // 5  # Double insurance
    bottom_limit = height - height // 5
    adjusted_contour = []
...
if __name__ == "__main__":
    ...
    color_image = cv2.imread('cropped_frame_0048.png', cv2.IMREAD_UNCHANGED)
